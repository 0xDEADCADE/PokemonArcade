...
# Pokemon character encoding conversion to unicode characters
charconversiontable = {"6": "ABCDEFGHIVSLM:ぃぅ", "7": "‘’“”・⋯ぁぇぉ╔═╗║╚╝ ", "8": "ABCDEFGHIJKLMNOP", "9": "QRSTUVWXYZ():;[]", "A": "abcdefghijklmnop", "B": ["q", "r", "s", "t", "u", "v", "w", "x", "y", "z", "é", "'d", "'l", "'s", "'t", "'v"], "E": ["'", "PK", "MN", "-", "'r", "'m", "?", "!", ".", "ァ", "ゥ", "ェ", "▷", "▶", "▼", "♂"], "F": "₽×./,♀0123456789"}
